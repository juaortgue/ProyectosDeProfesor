...
public class Tienda {
	...
	public void llenarAlmacen() {
		/*
		 * 1º Creamos los articulos 2º los añadimos a un array de articulos 3º el array
		...
		/*
		 * La salida de este programa debería ser la siguiente: Mostrando inventario de
		 * la tienda: ----------------------------------------------------------- [ 0]
	...
	public void mostrarInventario() {
		...
		for (int i = 0; i < this.getNumArticulos(); i++) {
			...
			System.out.println("Artículo: " + a.getNombre() + " (ref. " + a.getId() + ") ," + a.getPrecio() + " euros, "
	...
	public void aniadirCliente(Cliente c) {
		...
		// en base a lenght obtengo el nº de liente de mi tienda
